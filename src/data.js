export const projects = [
  {
    ...
    images: [
      ...
      { src: "/asistencia-4.png", caption: "Reportes" },
      { src: "/asistencia-5.png", caption: "Reportes" },
      { src: "/asistencia-6.png", caption: "Reportes" },
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/cflowers1.png", caption: "Registro QR" },
      { src: "/nosotro.png", caption: "Reportes" },
      { src: "/catalogo.png", caption: "Reportes" },
      ...
      sections: [
        {
          ...
          items: [
            ...
            "Footer Moderno con toda la información necesaria para un contacto rapido",
            "Sección de redes sociales que redirige a las redes de la empresa",
            "Boton de WhatsApp funcional que redirige al telefono de  la empresa",
          ],
        },
      ],
      closing: "",
  ...
  },
  {
    id: "004",
    featured: false,
    title: "Pagina web - Escuela Gaspar cabrales de Vaparaíso",
    desc: "Pagina desarrollada para la institución en react con js, donde aparece todo lo relacionado con la escuela ",
    tags: ["React Native", "js", "En desarrollo"],
    type: "https://gaspar-coral.vercel.app/ ",
     images: [
      { src: "/1.png", caption: "Panel principal" },
      { src: "/2.png", caption: "Registro QR" },
      { src: "/3.png", caption: "Reportes" },
      { src: "/4.png", caption: "Reportes" },

    ],
    details: {
      intro: "Pagina que destaca El proyecto educativo institucional su reglamento intern, su plan de mejora y  una variedad de información de gestion de la escuela. ",
      sections: [
        {
          title: "Características",
          items: [
            "Interfaz  adaptada al gusto de la directora del establecimiento.",
            "Integración de carrusel con imagenes de las actividades de la escuela",
            "Integracion de Videos subido  y creados  por mi don se muestras  pequeñas partes del evento realizado",
            "Footer con un titulo, con inforación relevante, del colegio como dirección,  número de telefono y email de contacto",
            "Formulario para hacer  consultas",
            "y un mapa de google para saber donde esta  ubicada la escuela.",
          ],
        },
      ],
      closing: "",
